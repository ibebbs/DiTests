...
namespace MediTests
{
    public class Tests
    {
        ...
        {
            var dependency = Container.ServiceProvider.Value.Get<IDependency>();
        ...
        [Test]
        [Ignore("Not supported by MEDI")]
        public void GetDependencyFactory()
        {
            var dependencyFactory = Container.ServiceProvider.Value.Get<IDependencyFactory>();
        ...
        {
            var dependency1 = Container.ServiceProvider.Value.Get<IModule1Dependency>();
            var dependency2 = Container.ServiceProvider.Value.Get<IModule2Dependency>();
        ...
        {
            var serviceConsumer1 = Container.ServiceProvider.Value.Get<IServiceConsumer>();
            ...
            var serviceConsumer2 = Container.ServiceProvider.Value.Get<IServiceConsumer>();
